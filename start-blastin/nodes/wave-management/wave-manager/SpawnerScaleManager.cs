...
//         {
//             [SpawnerLocation.Bottom] = [],
//             [SpawnerLocation.Top] = [],
//             [SpawnerLocation.Left] = [],
//             [SpawnerLocation.Right] = [],
//         };
...
//                     SpawnerLocation,
//                     List<SpawnerScaler>
//                 > formationKvp in _currentFormationScaler.NetFormation
//             )
//             {
//                 // Add spawners for each item in each spawner scaler list.
//                 await AddSpawners(formationKvp.Key, [.. formationKvp.Value]);
//             }
