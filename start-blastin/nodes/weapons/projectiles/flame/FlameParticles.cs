...
{
    [GlobalClass]
    public partial class FlameParticles : Projectile, ITetheredProjectile, IListener
    {
        ...
        public override async void ToggleActive(bool active)
        {
            if (active)
            {
                ...
                _collShape.SetDeferred(CollisionShape2D.PropertyName.Disabled, false);
            ...
            else
            {
                ...
                _collShape.SetDeferred(CollisionShape2D.PropertyName.Disabled, true);
